...
export default function AdminAIChat() {
  ...
  const sendMessage = (text: string) => {
    ...
    const response = adminChatResponses[text] || "I'm reviewing care data across all your gardens... Based on the current season and your plant profiles, I'd recommend checking each garden's seasonal care notes. Would you like a specific breakdown for any garden?";
    ...
    <div className="flex flex-col h-screen md:h-[calc(100vh)] bg-background">
      <div className="flex items-center gap-3 px-4 py-3 bg-card border-b border-border">
        ...
        <div className="flex-1">
          ...
          <p className="text-[10px] text-muted-foreground">Admin view — All Gardens</p>
        </div>
      </div>
        ...
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full gap-6 pb-20">
            ...
            <div className="text-center">
              <h3 className="font-display font-semibold text-foreground">Admin Garden Assistant</h3>
              <p className="text-sm text-muted-foreground mt-1">Ask about any garden, plant, or care schedule</p>
            </div>
