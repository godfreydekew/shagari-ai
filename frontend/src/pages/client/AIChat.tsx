...
export default function AIChat() {
  ...
  const sendMessage = (text: string) => {
    ...
    const response =
      chatResponses[text] ||
      "I'm checking your garden notes for that... Based on your garden profile, I'd recommend reaching out to your Shagari team for specific advice on this. They'll have the best insight for your particular situation.";
    ...
    <div className="flex flex-col h-screen md:h-[calc(100vh)] bg-background">
      ...
      <div className="px-4 py-2 bg-secondary/50">
        <p className="text-[10px] text-muted-foreground text-center">
          Answers are based on your specific garden. For urgent issues, contact
          your Shagari team.
        </p>
      </div>
          ...
          <div className="flex flex-col items-center justify-center h-full gap-6 pb-20">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                I know all about your plants and their care needs
              </p>
            </div>
